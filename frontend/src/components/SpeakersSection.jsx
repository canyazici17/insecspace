      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid gap-8 ${isThreeOrLess ? 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-center place-items-center' : 'sm:grid-cols-2 lg:grid-cols-4'}`}>
          {speakers.map((speaker) => (
            ...
            >
              {/* Card */}
              <div className="w-full h-full relative overflow-hidden rounded-lg bg-gradient-to-br from-gray-900 to-black border border-cyan-500/30 hover:border-cyan-400 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20">
                {/* Image Container */}
                ...
                <div className="p-6">
                  ...
                  {speaker.bio === 'linkedin' ? (
                    ...
                    <a
                      href="https://www.linkedin.com/in/aliberkol?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                    ...
                    >
                     ...
                     ) : speaker.bio === 'linkedin19' ? (
                    <a
                      href="https://www.linkedin.com/in/seyda?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin21' ? (
                    <a
                      href="https://www.linkedin.com/in/lokmankuzu?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin22' ? (
                    <a
                      href="https://www.linkedin.com/in/anilyagiz?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin24' ? (
                    <a
                      href="https://www.linkedin.com/in/zekeriya-çoştu-75a785ba?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                    ...
                    ) : speaker.bio === 'linkedin23' ? (
                    <a
                      href="https://www.linkedin.com/in/yusuf-kıraç-6a524061?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin25' ? (
                    <a
                      href="https://www.linkedin.com/in/m-fuat-eroglu-096bb351?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin26' ? (
                    <a
                      href="https://www.linkedin.com/in/cem-bilsel-9998446a?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                    ...
                    ) : speaker.bio === 'linkedin27' ? (
                    <a
                      href="https://www.linkedin.com/in/hasan-hüseyin-ertok-a7321718?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin29' ? (
                    <a
                      href="https://www.linkedin.com/in/ahmet-hamdi-atalay-9158984?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin28' ? (
                    <a
                      href="https://www.linkedin.com/in/dat-vo-10608464?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin30' ? (
                    <a
                      href="https://www.linkedin.com/in/ondertatar?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                    ...
                    ) : speaker.bio === 'linkedin31' ? (
                    <a
                      href="https://www.linkedin.com/in/ihsan-kusmez-a81a7a226?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin33' ? (
                    <a
                      href="https://www.linkedin.com/in/onur-tarakcioglu?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                    ...
                    ) : speaker.bio === 'linkedin32' ? (
                    <a
                      href="https://www.linkedin.com/in/fatih-ayhan-51078b19?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                     ...
                     ) : speaker.bio === 'linkedin34' ? (
                    <a
                      href="https://www.linkedin.com/in/gurkan-sencar-12a25b1b?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
                  ...
                  ) : speaker.bio === 'linkedin13' ? (
                    <a
                      href="https://www.linkedin.com/in/veli-y-7a052aa3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-cyan-500 hover:text-cyan-700 mt-2"
                    >
